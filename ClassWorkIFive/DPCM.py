...
if __name__ == '__main__':
    ...
    cons_img_outputpath=output_path+'construct_'+str(bit)+'_bit.jpg'
    diff_img_outputpath=output_path+'differ_'+str(bit)+'_bit.jpg'
    cv2.imwrite(cons_img_outputpath, cons_img)
    cv2.imwrite(diff_img_outputpath,diff_img)
